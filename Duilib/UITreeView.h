...
namespace DuiLib
{
	...
	public:
		...
		void	SetSelItemBkColor(DWORD _dwSelItemBkColor);
		DWORD	GetSelItemBkColor() const;
		void	SetItemBkColor(DWORD _dwSelItemBkColor);
		DWORD	GetItemBkColor() const;	
		void    SetSelItemFont(int iIndex);
		int     GetSelItemFont();
		void    SetFolderSelectedState(bool bSelected);
		bool    GetFolderSelectedState();
	...
	public:
		...
		virtual void SetItemExpandEx(bool _Expanded,CTreeNodeUI* _TreeNode = NULL);
		...
		virtual int GetItemArrayByName(CStdString pstrName, int *&pArray, bool bCmpNoCase = false);
